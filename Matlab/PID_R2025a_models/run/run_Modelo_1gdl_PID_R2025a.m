...
if ~isfile(fullfile(rootDir,"models","Modelo_1gdl_PID_R2025a.slx"))
    build_victor_pid_R2025a;
end
load_system(fullfile(rootDir,"models","Modelo_1gdl_PID_R2025a.slx"));
simOut = sim("Modelo_1gdl_PID_R2025a");
save(fullfile(resultDir,"Modelo_1gdl_PID_R2025a_simout.mat"), "simOut");
open_system("Modelo_1gdl_PID_R2025a");
